...
<body>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		$insert_query = "INSERT INTO class1 (name,sub1,sub2,sub3,sub4,sub5,total_obtained,total_marks,percent) VALUES('$name',$sub1,$sub2,$sub3,$sub4,$sub5,$total,500,$percentage)";
